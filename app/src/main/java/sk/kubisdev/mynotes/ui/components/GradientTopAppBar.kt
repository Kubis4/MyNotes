...
fun gradientHeaderBrush(): Brush {
    val brand = sk.kubisdev.mynotes.ui.theme.LocalBrandGradient.current
...
fun BrandFloatingActionButton(
    ...
    androidx.compose.material3.FloatingActionButton(
        ...
        contentColor = sk.kubisdev.mynotes.ui.screens.getTextColorForBackground(brand.start),
...
fun GradientTopAppBar(
    ...
    val background = if (gradientEnabled) {
        ...
        Modifier.background(sk.kubisdev.mynotes.ui.theme.LocalBrandGradient.current.start)
    }
